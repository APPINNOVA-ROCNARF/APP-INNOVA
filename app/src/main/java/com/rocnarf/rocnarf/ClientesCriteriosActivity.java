...
import com.rocnarf.rocnarf.Utils.Common;import android.content.Intent;
...
public class ClientesCriteriosActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clientes_criterios);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if (position == 0 )
                return ClientesCriteriosFragment.newInstance(ClientesCriteriosFragment.DEST_PLANIFICACION, idUsuario, seccion);
            else
