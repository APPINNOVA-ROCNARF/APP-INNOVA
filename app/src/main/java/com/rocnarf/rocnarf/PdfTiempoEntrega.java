...
public class PdfTiempoEntrega extends AsyncTask<String,Void, InputStream> {
    ...
    public int  idGuia;
    public PdfTiempoEntrega(PDFView pdfView, ProgressBar progressBar, TextView textView) {
...
//        }
    ...
    protected void onPostExecute(InputStream inputStream) {
            ...
            Call<ResponseBody> call = downloadService.downloadFileTiempoEntrega();
